            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="well">
                    ...
                    <h4 class="split_two"> Insert Into Some Table </h4>
                    <span class="split_two"><a href="tables.php" class="btn btn-danger pull-right">Go Back</a></span>
              	...
              	<form id="edit_table" class="well" method="post" action="create_new.php">
                    ...
                    <div style="text-align:center">
              			<input  type="submit" name="insert_values" value="Insert Value" class="btn btn-danger "/>
                  </div>
                  </div>
              	</form>
