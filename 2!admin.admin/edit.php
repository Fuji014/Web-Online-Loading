            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="well">
                    ...
                    <h4 class="split_two"> Edit Some Table </h4>
                    <a href="delete.php" class="split_two btn btn-danger pull-right"> Delete this item</a>
                    <span class="split_two"><a href="tables.php" class="btn btn-default pull-right">Go Back</a>
                    </span>
              	...
              	<form class="well" action="edit.php?id=<?php echo $_GET['id']; ?>" method="post">
              		...
              		<div class="form_elements">
              			<input type="submit" name="edit_values" value="Edit Value" class="btn btn-danger"/>
              		</div>
