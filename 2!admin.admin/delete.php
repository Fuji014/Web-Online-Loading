<?php
  ...
  include_once( 'libs/listTables.php' ); //header
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="Tables.php" class="list-group-item"><span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span> Tables <span class="badge">12</span></a>
              ...
              <div class="panel-body">
                <!-- content -->
						    ...
						    <div class="well">
						        ...
						        <h4 class="left"> Delete From Some Table </h4>

						    </div>
								<div class="alert alert-info">
									<h4> Are you sure you want to delete data for id <?php echo $_GET['id']; ?>?</h4>
									<a href="delete.php?id=<?php echo $_GET['id']; ?>&delete=true" class="btn btn-danger">Yes Delete</a>
									<a href="tables.php" class="btn"> Cancel </a>
								</div>
